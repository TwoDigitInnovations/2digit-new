    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="text-center mt-10 md:mt-16 px-4 md:px-6">
        ...
        <p className="text-gray-600 text-base md:text-lg mb-6">
          At 2digit innovations, accessible from 2digit innovations, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by 2digit innovationsand how we use it. If you have additional
          ...
          the information that they shared and/or collect in 2digit innovations.
      ...
      <div className="text-center mt-10 md:mt-16 px-4 md:px-6">
        ...
        <p className="text-gray-600 text-base md:text-lg mb-6">
          ...
          <ul className="text-gray-600 text-base md:text-lg mb-6">
      ...
      <div className="text-center mt-10 md:mt-16 px-4 md:px-6">
        ...
        <p className="text-gray-600 text-base md:text-lg mb-6">
          2digit innovations follows a standard procedure of using log files.
      ...
      <div className="text-center mt-10 md:mt-16 px-4 md:px-6">
        ...
        <p className="text-gray-600 text-base md:text-lg mb-6">
          ...
          advertising partners of 2digit innovations. Third-party ad servers or
          ...
          on 2digit innovations, which are sent directly to users' browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that 2digit
          innovationshas no access to or control over these cookies that are
      ...
      <div className="text-center mt-10 md:mt-16 px-4 md:px-6">
        ...
        <p className="text-gray-600 text-base md:text-lg mb-6">
          2digit innovations's Privacy Policy does not apply to other
      ...
      <div className="text-center mt-10 md:mt-16 px-4 md:px-6">
        ...
        <p className="text-gray-600 text-base md:text-lg mb-6">
          ...
          participate in, and/or monitor and guide their online activity. 2digit
          innovationsdoes not knowingly collect any Personal Identifiable
