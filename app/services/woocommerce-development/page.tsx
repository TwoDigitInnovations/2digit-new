...
export default function Home() {
  ...
  const features = [
    { title: "WooCommerce Store Setup", href: "/services/ios" },
    { title: "Custom Theme Development", href: "/services/android" },
    {
      title: "Plugin Customization & Extensions",
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        Services | Powerful E-commerce{" "}
          </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">on WordPress
</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
Transform your WordPress website into a full-featured online store with WooCommerce, the world's most popular open-source e-commerce solution. At 2Digit Innovations, we specialize in WooCommerce development with custom themes, plugin customization, and payment integrations. From small businesses launching online stores to established retailers needing flexible e-commerce, we deliver WooCommerce solutions that drive real business results across the UK, USA, and India.
        </p>
...
Complete WooCommerce Development Solutions for Your Business Growth
            </h2>
...
Complete WordPress E-commerce Configuration: Launch your WooCommerce store with professional setup and optimization. We install and configure WooCommerce, set up payment gateways, configure shipping methods, import product catalogs, and optimize for SEO—delivering fully functional WordPress-powered stores ready to start selling immediately.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Custom Theme Development
</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
Branded Shopping Experiences Built on WordPress: Create unique WooCommerce stores with custom WordPress themes designed specifically for your brand. We develop responsive e-commerce themes, optimize product page layouts, implement custom checkout designs, and ensure seamless WooCommerce integration, building stores that combine WordPress flexibility with e-commerce power.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Plugin Customization & Extensions</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
Extend WooCommerce with Custom Functionality: Enhance your WooCommerce store with custom plugins and extensions tailored to your needs. We develop custom WooCommerce plugins, integrate third-party extensions, implement subscription systems, and add advanced features, extending your store's capabilities beyond standard WooCommerce functionality.
            </p>
...
We understand your products, WordPress needs, and business goals to design WooCommerce stores that leverage WordPress's flexibility while maximizing e-commerce performance.
...
Setup & Customization
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
Our WordPress experts install WooCommerce, develop custom themes, configure plugins, integrate payment systems, and optimize for speed and conversions.
...
Testing & Launch
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
We test shopping flows, payment processing, and WordPress-WooCommerce integration, train you on store management, then launch your store ready for sales.
...
Why Choose 2Digit Innovations for WooCommerce Development?
          </h2>
...
With 500+ completed projects and 450+ satisfied clients, we've mastered WordPress and WooCommerce development, ensuring your store is powerful and maintainable.
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
WordPress Flexibility Advantage 
              </h3>
              <p className="text-[#fff] leading-relaxed">
From content marketing to blogging and e-commerce, we leverage WordPress's versatility to create stores that combine content and commerce seamlessly.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
Focus on Open-Source Power 
              </h3>
              <p className="text-[#fff] leading-relaxed">
We build WooCommerce stores that you truly own, every customization, plugin, and extension gives you complete control without vendor lock-in or platform fees.
