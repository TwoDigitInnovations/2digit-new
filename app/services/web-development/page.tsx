...
export default function Home() {
  ...
  const features = [
    ...
    { title: "Corporate Websites", href: "/services/corporate-websites" },
  ];
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          ...
          <span className="text-black">
            Services | Build Websites That Drive{" "}
          </span>
        ...
        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your business vision into powerful web solutions that users
          love. At 2Digit Innovations, we specialize in creating
          high-performance websites and web applications using modern
          technologies like React.js, Node.js, and Laravel. From startups
          launching their first website to enterprises scaling their digital
          presence, we deliver web experiences that engage users and drive real
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Web Development Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Beautiful Interfaces Built with Modern Frameworks: Create
              stunning, responsive user interfaces with cutting-edge frontend
              technologies. Our expert developers use React.js, Next.js,
              Angular, and Vue.js to build fast, interactive web experiences
              that captivate users and deliver exceptional performance across
              all devices.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Powerful Server-Side Solutions for Scalability: Build robust,
              secure backend systems that power your web applications. Using
              Node.js, PHP, Laravel, Django, and Python, we develop scalable
              server architectures that handle complex business logic, ensuring
              your platform performs flawlessly under any load.{" "}
            </p>

            <div className="space-y-4">
              {[
                "Node.js & PHP development",
                "Laravel framework expertise",
                "Django & Python solutions",
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              End-to-End Development with Modern Stacks: Get complete web
              solutions with seamless frontend and backend integration. Our
              full-stack developers master MERN, MEAN, and JAMstack to deliver
              cohesive applications where every component works in perfect
              harmony for optimal performance.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Enterprise-Grade Applications That Scale: Build powerful SaaS
              platforms and enterprise web applications that handle complex
              workflows. Our developers create scalable, secure web apps that
              support your business processes, enhance productivity, and deliver
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                ...
                and competitive landscape to create a strategic roadmap for your
                website's success.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our UI/UX experts craft intuitive, engaging interfaces with
                interactive prototypes that bring your vision to life before a
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our developers build your website using agile methodology, with
                rigorous testing at every stage to ensure flawless
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Web Development?
          </h2>
