      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          ...
          <span className="text-black">
            Testing Services | Deliver Flawless{" "}
          </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">Software Every Time</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your software quality with comprehensive testing services
          that catch bugs before your users do. At 2Digit Innovations, we
          specialize in manual and automated testing for web, mobile, and API
          applications ensuring flawless functionality, security, and
          performance. From startups launching MVPs to enterprises maintaining
          critical systems, we deliver rigorous QA that protects your reputation
          and drives real business results across the UK, USA, and India.
        </p>
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Quality Assurance & Testing Solutions for Your Business
              Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Human Expertise for Comprehensive Quality Validation: Ensure every
              feature works perfectly with thorough manual testing by
              experienced QA professionals. Our testers perform functional
              testing, regression testing, and user acceptance testing (UAT) to
              validate your software meets requirements and delivers exceptional
              user experiences.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Fast, Reliable Testing with Continuous Integration: Accelerate
              your release cycles with intelligent test automation that runs
              continuously. We build automated test suites, integrate with CI/CD
              pipelines, and implement continuous testing strategies that catch
              bugs early while reducing testing time and costs significantly.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Flawless Performance Across All Devices: Ensure your mobile app
              works perfectly on every device and OS version. Our mobile testing
              covers iOS and Android platforms with comprehensive cross-device
              testing, validating functionality, performance, and user
              experience across thousands of device configurations.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We analyze your application, identify critical test scenarios,
                and create comprehensive test plans that ensure complete
                coverage and maximum bug detection.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our QA team executes test cases systematically, documents
                defects with detailed reproduction steps, and provides clear
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We track bugs through resolution, verify fixes thoroughly, and
                perform regression testing to ensure new changes don't introduce
                additional issues.
              </p>
            </div>
          </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Quality Assurance & Testing?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
                Proven Testing Excellence
              </h3>
              <p className="text-[#fff] leading-relaxed">
                With 500+ completed projects and 450+ satisfied clients, we've
                prevented countless bugs from reaching production, ensuring your
                software launches with confidence and quality.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From manual and automated testing to security and performance
                validation, we cover every aspect of quality assurance with
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We test for user satisfaction and business success, every bug
                caught saves you reputation damage, support costs, and lost
                revenue from frustrated users.
              </p>
            </div>
          </div>
        </div>
