      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          ...
          <span className="text-black">
            Development Services | Build Solutions{" "}
          </span>
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Custom Software Development Solutions for Your Business
              Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Powerful Systems Built for Enterprise Operations: Design and
              develop comprehensive enterprise software including ERP, CRM, SCM,
              and HRM systems tailored to your organization's processes. We
              build scalable solutions that streamline operations, improve
              efficiency, and give you complete control over your business
              workflows.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Scalable Cloud Applications with Recurring Revenue: Build
              multi-tenant SaaS platforms that serve thousands of customers
              simultaneously. Our expertise in subscription management,
              automated billing, and scalable architecture ensures your SaaS
              business grows efficiently while delivering exceptional user
              experiences.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Leverage the Power of Cloud Computing: Develop robust cloud-native
              applications on AWS, Azure, or Google Cloud platforms. We
              architect solutions that scale automatically, reduce
              infrastructure costs, and provide high availability—ensuring your
              software performs flawlessly under any demand.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Breathe New Life into Outdated Systems: Transform legacy
              applications into modern, efficient software without losing
              critical business logic. Our code refactoring, migration, and
              re-platforming services update your technology stack while
              maintaining data integrity and minimizing business disruption.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We deeply understand your business processes, pain points, and
                objectives to define precise requirements and create a strategic
                development roadmap.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our experts architect scalable, secure solutions and design
                intuitive interfaces that align perfectly with your workflows
                and user needs.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our developers build your custom software using agile
                methodology, with rigorous testing and phased deployment to
                ensure seamless integration into your operations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Custom Software Development?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                ...
                delivered custom solutions across diverse industries, ensuring
                your software is built with deep technical expertise.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From requirements analysis to design, development, testing, and
                deployment, we handle everything with seamless execution that
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We build solutions that solve real problems, every feature and
                integration is designed to improve efficiency, reduce costs, and
