...
export default function Home() {
  ...
  const features = [
    {
      label: "Food Delivery App Solution",
      href: "/food-delivery-app",
    },
    {
      label: "Grocery Delivery App Solution",
      href: "/grocery-delivery-app",
    },
    {
      label: "Taxi Booking App Solution",
      href: "/taxi-booking-app",
    },
    {
      label: "E-commerce App Solution",
      href: "/ecommerce-app",
    },
    {
      label: "Clothing Store App Solution",
      href: "/clothing-store-app",
    },
  ];
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          Ready-Made App {"  "}
          <span className="text-black">Solutions | Launch Your Business </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">App in Days, Not Months</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your business idea into reality with our pre-built,
          customizable app solutions. At 2Dig it Innovations, we offer ready-made
          mobile applications across multiple industries, from food delivery to
          taxi booking and e-commerce. Skip months of development and launch
          your fully-featured app quickly and affordably, complete with all the
          tools you need to succeed across the UK, USA, and India.
        </p>
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Ready-Made App Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Launch Your Food Delivery Platform Instantly: Get your restaurant
              delivery business up and running with our complete food delivery
              solution. Manage multiple restaurants, track deliveries in
              real-time, and process payments seamlessly everything you need to
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Bring Fresh Groceries to Customers' Doorsteps: Start your grocery
              delivery service with our ready-made solution featuring inventory
              management and multi-store support. Perfect for supermarkets,
              local grocers, or entrepreneurs entering the online grocery market
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Build Your Ride-Hailing Business Fast: Launch your own taxi
              booking service with intelligent ride matching, GPS tracking, and
              automated fare calculation. Compete with Uber and Lyft with a
              fully-branded platform that gives you complete control over
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Start Selling Online Today: Get your online store running with our
              complete e-commerce app featuring product catalogs, shopping cart,
              secure checkout, and payment processing. Perfect for retailers
              ready to expand their business into mobile commerce quickly and
              affordably.
            </p>
      ...
      <section className="bg-[#fff] py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-14">
            Our Ready-Made App Launch Process
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your business needs and customize the app with
                your branding, colors, and specific features to match your
                vision perfectly.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our team configures your app, sets up payment gateways, and
                integrates necessary third-party services to ensure everything
                works seamlessly.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We thoroughly test your customized app across devices and
                platforms, then launch it on App Store and Google Play for
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Ready-Made App Solutions?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                With 500+ completed projects and 450+ satisfied clients, our
                proven ready-made solutions let you launch in weeks instead of
                months, giving you competitive advantage.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From consultation to launch, we deliver complete app solutions
                at a fraction of custom development costs while maintaining
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We provide solutions that drive revenue growth, every feature is
                designed to maximize user engagement, streamline operations, and
