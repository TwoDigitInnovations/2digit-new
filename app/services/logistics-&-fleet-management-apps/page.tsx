...
export default function Home() {
  ...
  const features = [
    { title: "Fleet Tracking & Management", href: "/services/ios" },
    { title: "Route Optimization & Planning", href: "/services/android" },
    {
      title: "Driver Management & Dispatch",
      href: "/services/cross-platform",
    },
    { title: "Delivery Coordination & Proof", href: "/services/android" },
  ];
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          ...
          <span className="text-yellow-500"> Optimize Operations & Delivery</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform logistics operations with powerful fleet management and
          delivery apps that maximize efficiency and reduce costs. At 2Digit
          Innovations, we specialize in developing comprehensive logistics
          platforms with real-time tracking, route optimization, driver
          management, and delivery coordination. Our portfolio includes
          successful apps like HIRO Logistics and DiverX. From startups
          disrupting logistics to enterprises managing large fleets, we deliver
          solutions that drive real business results across the UK, USA, and
          India.
        </p>
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Logistics & Fleet Management Solutions for Your Business
              Growth
            </h2>
  ...
  "
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Real-Time Visibility Across Your Entire Fleet: Gain complete
              control with comprehensive fleet tracking that monitors vehicle
              locations, status, and performance in real-time. We build systems
              with GPS tracking, vehicle health monitoring, fuel management, and
              maintenance scheduling, helping you maximize fleet utilization
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Smart Routing That Saves Time and Fuel: Maximize delivery
              efficiency with intelligent route optimization that considers
              traffic, distance, delivery windows, and vehicle capacity. Our
              algorithms calculate optimal routes dynamically, reduce fuel
              consumption, minimize delivery times, and increase the number of
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h2>Driver Management & Dispatch</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
              Streamlined Driver Coordination for Maximum Productivity: Empower
              your logistics team with comprehensive driver management featuring
              job assignment, performance tracking, communication tools, and
              timesheet management. We build dispatch systems that assign jobs
              efficiently, track driver availability, and provide real-time
              communication, ensuring smooth operations and accountability.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Delivery Coordination & Proof
            </h2>

            <p className="text-gray-600 mb-8 max-w-xl">
              Complete Delivery Management from Pickup to Drop-off: Ensure
              delivery accuracy with comprehensive coordination features
              including digital signatures, photo proof, barcode scanning, and
              customer notifications. Our systems track delivery status, capture
              proof of delivery, and provide customers with real-time updates,
              reducing disputes and improving customer satisfaction.
            </p>
      ...
      <section className="bg-[#fff] py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-14">
            Our Logistics & Fleet Management App Development Process
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-[#4a4a4a] mb-4">
                Discovery & Operations Analysis
              </h3>
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your logistics workflows, fleet size, and
                operational challenges to design platforms that streamline
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our designers create functional driver and dispatcher interfaces
                while developers build robust systems with GPS tracking, route
                optimization, and delivery management capabilities.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We conduct field testing with drivers and dispatchers, optimize
                routing algorithms and tracking accuracy, then launch your
                platform on App Store and Google Play.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Logistics & Fleet Management App
            Development?{" "}
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                With successful projects like HIRO Logistics and DiverX, plus
                500+ completed projects and 450+ satisfied clients, we
                understand fleet operations and delivery challenges deeply.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From route optimization to fleet tracking, every feature is
                designed to reduce costs, save time, and maximize the
                productivity of your logistics operations.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We build apps that transform operations, every tracking feature,
                routing algorithm, and management tool is optimized to improve
