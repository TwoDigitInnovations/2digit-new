    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          UI/UX Design{"  "}
          <span className="text-black">Services | Create Experiences </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">That Users Love</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your digital products into delightful experiences that
          captivate users and drive conversions. At 2Digit Innovations, we
          specialize in creating intuitive user interfaces and seamless user
          experiences for web and mobile applications. From startups crafting
          their first product to enterprises redesigning complex systems, we
          deliver designs that engage users and drive real business results
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete UI/UX Design Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Beautiful Visual Designs That Make Lasting Impressions: Create
              stunning visual interfaces that reflect your brand identity and
              captivate users. Our UI designers craft pixel-perfect designs,
              comprehensive design systems, and detailed style guides that
              ensure consistency and visual excellence across every touchpoint.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Research-Driven Design That Solves Real Problems: Build products
              users actually need through deep user research and strategic UX
              planning. We conduct user interviews, create journey maps, and
              develop wireframes that optimize every interaction ensuring your
              product is intuitive, efficient, and delightful to use.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Native-Feeling Designs for iOS and Android: Design mobile
              experiences that feel natural on every platform. Our designers
              master iOS Human Interface Guidelines and Android Material Design
              principles, creating apps that users instinctively understand
              while maintaining your unique brand identity.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Content */}
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Web Design</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
              Responsive Websites That Convert Across All Devices: Create
              stunning web designs that adapt seamlessly from desktop to mobile.
              Our responsive design approach ensures beautiful layouts,
              fast-loading landing pages, and consistent user experiences that
              drive conversions regardless of device or screen size.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your users, analyze competitors, and define design
                requirements to create a strategic foundation for exceptional
                user experiences.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our designers create wireframes, design mockups, and interactive
                prototypes that bring your vision to life with pixel-perfect
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We conduct usability testing with real users, gather feedback,
                and refine designs iteratively to ensure your final product
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for UI/UX Design?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
                Proven Design Excellence
              </h3>
              <p className="text-[#fff] leading-relaxed">
                With 500+ completed projects and 450+ satisfied clients, we've
                crafted award-winning designs across industries, ensuring your
                product is built with exceptional design expertise.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From research and wireframing to prototyping and testing, we
                prioritize user needs at every stage, creating experiences that
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We design for conversions and engagement, every color, button,
                and interaction is strategically crafted to achieve your
