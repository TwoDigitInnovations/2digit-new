...
export default function Home() {
  ...
  const features = [
    { title: "Magento 2 Stores", href: "/services/ios" },
    { title: "B2B Commerce Solutions", href: "/services/android" },
    // {
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        Services | Enterprise E-commerce {" "}
          </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">That Scales
</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
Transform your retail business with Magento, the powerful open-source platform built for enterprise-scale e-commerce. At 2Digit Innovations, we specialize in Magento 2 development with custom extensions, B2B functionality, and performance optimization. From growing businesses needing advanced features to enterprises managing complex catalogs, we deliver Magento solutions that drive real business results across the UK, USA, and India.
        </p>
...
Complete Magento Development Solutions for Your Business Growth
            </h2>
...
Powerful, Scalable E-commerce for Growing Businesses: Build robust Magento 2 stores that handle thousands of products and high traffic volumes. We develop custom Magento themes, configure multi-store setups, implement advanced catalog management, and optimize performance, delivering enterprise-grade e-commerce platforms that scale effortlessly as your business grows.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">B2B Commerce Solutions
</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
Specialized Features for Business-to-Business Sales: Create powerful B2B e-commerce with Magento's advanced business features. We implement customer-specific pricing, configure quote management systems, add bulk ordering capabilities, and create company account structures, enabling sophisticated B2B transactions with credit terms, approval workflows, and tiered pricing.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">App Integration</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
Extend Functionality with Powerful Shopify Apps: Enhance your Shopify store with strategic app integrations that add advanced features. We integrate marketing automation tools, implement inventory management systems, add customer review apps, and connect analytics platforms, extending your store's capabilities to match your business requirements.
            </p>
...
We understand your catalog complexity, B2B requirements, and scalability needs to design Magento architectures that handle enterprise-level e-commerce demands.
...
Development & Customization
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
Our Magento experts build custom themes, develop extensions, configure B2B features, optimize database performance, and integrate with enterprise systems.
...
Testing & Deployment
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
We conduct performance testing under load, validate complex pricing and catalog configurations, optimize server infrastructure, then deploy your Magento store ready to scale.
...
Why Choose 2Digit Innovations for Magento Development?
          </h2>
...
Proven Magento Expertise
              </h3>
              <p className="text-[#fff] leading-relaxed">
With 500+ completed projects and 450+ satisfied clients, we're experienced Magento developers who understand the platform's enterprise capabilities and complexities.
...
Enterprise-Scale Solutions 
              ...
              <p className="text-[#fff] leading-relaxed">
From massive product catalogs to B2B functionality and multi-store management, we build Magento stores that handle the most demanding e-commerce requirements.
              </p>
            </div>
...
Focus on Performance
              ...
              <p className="text-[#fff] leading-relaxed">
We build Magento stores that stay fast, every customization, database query, and server configuration is optimized to maintain speed even with large catalogs.
