    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          Maintenance & Support {"  "}
          <span className="text-black">Services | Keep Your Software </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">Running Flawlessly</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your software's long-term success with comprehensive
          maintenance and support services that ensure peak performance and
          reliability. At 2Digit Innovations, we specialize in application
          maintenance, technical support, performance optimization, and security
          updates that keep your systems running smoothly 24/7. From startups
          needing ongoing development to enterprises maintaining critical
          applications, we deliver support solutions that drive real business
          results across the UK, USA, and India.
        </p>
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Maintenance & Support Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Continuous Updates for Peak Performance: Keep your applications
              running smoothly with proactive maintenance services that prevent
              issues before they impact users. We provide bug fixes, feature
              updates, and continuous enhancements that ensure your software
              evolves with changing business needs and stays competitive in the
              market.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Your Extended Tech Team On-Demand: Scale your development capacity
              instantly with dedicated developers who work as an extension of
              your team. Our retainer models and extended team services provide
              consistent, reliable development resources that understand your
              business and deliver results without the overhead of hiring.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Expert Help When You Need It Most: Get immediate assistance with
              24/7 technical support that keeps your systems online and users
              happy. Our SLA-based support guarantees rapid response times,
              expert troubleshooting, and proactive monitoring—ensuring issues
              are resolved quickly before they impact your business operations.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Maximize Speed and Efficiency: Eliminate slowdowns and bottlenecks
              with comprehensive performance optimization services. We conduct
              speed optimization, database tuning, code refactoring, and
              infrastructure improvements that make your applications faster,
              more responsive, and capable of handling increased traffic
              seamlessly.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We evaluate your application's current state, identify potential
                issues, and create a comprehensive maintenance plan tailored to
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our team continuously monitors your systems, applies updates
                promptly, and performs regular maintenance tasks to ensure
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We provide detailed reports on system health, incident
                resolution, and performance metrics while continuously
                optimizing to improve reliability and efficiency.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Maintenance & Support?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
                Proven Support Excellence
              </h3>
              <p className="text-[#fff] leading-relaxed">
                With 500+ completed projects and 450+ satisfied clients, we've
                maintained critical applications across industries, ensuring
                your software runs flawlessly with minimal downtime.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From monitoring and maintenance to optimization and security, we
                prevent problems before they occur rather than just reacting to
                issues.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We protect your operations and revenue, every update, fix, and
                optimization is designed to maximize uptime, user satisfaction,
