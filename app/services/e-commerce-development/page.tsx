    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          E-commerce {"  "}
          <span className="text-black">Services | Build Online Stores </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">That Drive Sales Growth</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your retail vision into a powerful online store that
          customers love. At 2Digit Innovations, we specialize in creating
          high-performance e-commerce websites and mobile apps that drive sales
          and conversions. From startups launching their first online store to
          enterprises scaling their digital commerce, we deliver shopping
          experiences that engage customers and drive real business results
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete E-commerce Development Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Stunning Online Stores That Convert Visitors into Customers:
              Create beautiful, high-converting e-commerce websites that drive
              sales. Our portfolio includes XO Candles, Octopusgifts, and Primax
              Trading each designed with seamless shopping experiences, secure
              payment processing, and features that turn browsers into buyers.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Shopping Apps That Keep Customers Coming Back: Deliver seamless
              mobile shopping experiences with native iOS and Android e-commerce
              apps. Push notifications, one-tap checkout, and personalized
              recommendations keep customers engaged while driving repeat
              purchases and building lasting brand loyalty.
            </p>

            <div className="space-y-4">
              {[
                "Native iOS shopping apps",
                "Android e-commerce solutions",
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Build Thriving Marketplaces That Connect Buyers and Sellers:
              Launch powerful B2B, B2C, or C2C marketplace platforms where
              multiple vendors can sell products. We create scalable marketplace
              solutions with vendor management, commission tracking, and
              seamless payment distribution that grow your platform revenue.
            </p>

            <div className="space-y-4">
              {[
                "B2B/B2C/C2C marketplace platforms",
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Tailored Shopping Experiences That Set You Apart: Break free from
              template limitations with custom e-commerce solutions built for
              your unique business needs. From headless commerce architectures
              to bespoke shopping experiences, we create innovative platforms
              that give you competitive advantages and exceptional flexibility.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We start by understanding your products, target customers, and
                business model to create a strategic roadmap for your online
                store's success.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our UI/UX experts craft conversion-focused interfaces with
                interactive prototypes that optimize every step of the customer
                journey from browse to purchase.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our developers build your e-commerce platform using agile
                methodology, with rigorous testing at every stage to ensure
                flawless functionality, security, and performance.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for E-commerce Development?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                ...
                mastered every mobile platform and framework, ensuring your app
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From concept and design to development, testing, and App Store
                launch, we handle everything with seamless execution that
                eliminates coordination hassles.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We build solutions that drive growth, every feature and
                interaction is designed to achieve your business objectives,
                from revenue to engagement.
              </p>
            </div>
          </div>
        </div>
