...
export default function Home() {
  ...
  const features = [
    { title: "Professional Design & Branding", href: "/services/ios" },
    { title: "Content Management Systems", href: "/services/android" },
    {
      title: "Investor Relations & Resources",
      href: "/services/cross-platform",
    },
    { title: "Multi-Language Support    ", href: "/services/pwa" },
  ];
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          Corporate Website{"  "}
          <span className="text-black">Development Services | Build </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">Authority and Trust Online</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your corporate presence with professional websites that
          establish credibility and showcase your business excellence. At 2Digit
          Innovations, we specialize in developing sophisticated corporate
          websites that reflect your brand values and engage stakeholders
          effectively. Our portfolio includes successful projects like JJ-Owen,
          Twin Hatch, and Byzantine. From growing businesses to established
          enterprises, we deliver corporate web solutions that drive real
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Corporate Website Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Websites That Reflect Your Corporate Excellence: Create stunning
              corporate websites with sophisticated designs that communicate
              professionalism and build trust. We craft pixel-perfect layouts,
              implement consistent brand identity, design compelling visuals,
              and create intuitive navigation, ensuring your website makes
              powerful first impressions that reflect your company's stature and
              values.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Easy Updates for Your Corporate Content: Empower your team to
              manage corporate content effortlessly with user-friendly CMS
              integration. We implement WordPress or custom CMS solutions,
              create role-based access controls, design intuitive editing
              interfaces, and provide comprehensive training—giving you complete
              control over news, announcements, and company information.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Dedicated Sections for Stakeholder Engagement: Build trust with
              investors and stakeholders through dedicated resource sections. We
              create financial report archives, implement document libraries,
              design press release sections, and build contact forms, providing
              transparent communication channels that meet corporate governance
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Reach Global Audiences in Their Language: Expand your corporate
              reach with multi-language website capabilities. We implement
              language switchers, configure localized content management,
              optimize for international SEO, and ensure consistent branding
              across languages, helping your corporation communicate effectively
              with global stakeholders and markets.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                "Consistent cross-language branding",
              ].map((item, index) => (
                <div
                  key={index}
                  className="border border-purple-300 rounded-full px-6 py-3 text-gray-800 bg-white/70 backdrop-blur"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your corporate identity, stakeholder needs, and
                business objectives to design websites that align with your
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our team creates professional designs that reflect your
                corporate stature while developers build secure, scalable
                websites with all required features and integrations.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We conduct thorough testing for functionality, security, and
                performance, ensure compliance with corporate standards, then
                launch with comprehensive documentation and support.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Corporate Website Development?{" "}
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                With successful projects like JJ-Owen, Twin Hatch, and
                Byzantine, plus 500+ completed projects and 450+ satisfied
                clients, we understand corporate website requirements deeply.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From design to security and performance, we deliver websites
                that meet the high standards expected of corporate entities and
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We build websites that support business objectives, every
                feature from investor relations to content management is
                designed to enhance your corporate reputation and engagement.
              </p>
            </div>
          </div>
        </div>
