...
export default function Home() {
  ...
  const features = [
    { title: "Node.js Development", href: "/services/ios" },
    { title: "PHP Development", href: "/services/android" },
    {
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          Backend Development{"  "}
          <span className="text-black">Services | Build Robust, Scalable </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">Server-Side Solutions</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your web applications with powerful backend development that
          ensures security, performance, and scalability. At 2Digit Innovations,
          we specialize in building robust server-side systems using Node.js,
          PHP, Laravel, Django, and Python. From startups building MVPs to
          enterprises handling millions of users, we deliver backend solutions
          that power seamless experiences and drive real business results across
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Backend Development Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              ...
              lightning-fast, scalable backend systems with Node.js that handle
              real-time data and concurrent connections effortlessly. Our
              Node.js experts create RESTful APIs, implement WebSocket
              connections, and leverage asynchronous programming, delivering
              non-blocking, event-driven backends perfect for chat apps,
              streaming platforms, and collaborative tools.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Reliable, Proven Technology for Web Applications: Create robust
              web backends with PHP, the world's most popular server-side
              language powering millions of websites. Our PHP developers build
              secure, efficient server logic, implement database operations, and
              create dynamic web applications, delivering reliable backend
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Elegant PHP Framework for Rapid Development: Accelerate backend
              development with Laravel's expressive, elegant syntax and powerful
              features. We build scalable web applications with built-in
              authentication, routing, caching, and queue management, delivering
              clean, maintainable code that reduces development time while
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We design scalable backend architectures, define database
                schemas, and plan API structures that support your business
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our backend developers build secure server logic, implement
                database operations, create APIs, and integrate third-party
                services with best practices and clean code.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We conduct comprehensive testing including unit tests,
                integration tests, and load testing, then deploy to production
                with CI/CD pipelines for reliable releases.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Backend Development?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                ...
                built scalable backends across industries, ensuring your
                server-side infrastructure is rock-solid.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From input validation to encryption and authentication, we
                implement security best practices at every layer to protect your
                data and users.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We build backends that grow with you, every database query, API
                endpoint, and server architecture is optimized to handle
                increasing loads efficiently.
              </p>
            </div>
          </div>
        </div>
