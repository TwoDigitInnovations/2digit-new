...
export default function Home() {
  ...
  const features = [
    { title: "React.js Development", href: "/services/ios" },
    { title: "Next.js Development", href: "/services/android" },
    {
      title: "Angular Development",
      href: "/services/cross-platform",
    },
    { title: "Vue.js Development", href: "/services/pwa" },
  ];
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          ...
          <span className="text-black">
            Services | Create Beautiful, Fast,{" "}
          </span>
        ...
        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your web presence with stunning frontend development that
          captivates users and delivers exceptional performance. At 2Digit
          Innovations, we specialize in building modern, responsive user
          interfaces using React.js, Next.js, Angular, and Vue.js. From startups
          launching innovative web apps to enterprises modernizing their digital
          experiences, we deliver frontend solutions that engage users and drive
          real business results across the UK, USA, and India.
        </p>
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Frontend Development Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Component-Based Architecture for Scalable Interfaces: Build
              dynamic, interactive web applications with React.js, the most
              popular JavaScript library for modern frontend development. Our
              React experts create reusable components, implement efficient
              state management, and leverage React's virtual DOM, delivering
              lightning-fast interfaces that scale beautifully as your
              application grows.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              SEO-Optimized React with Server-Side Rendering: Enhance your React
              applications with Next.js for superior performance, SEO, and user
              experience. We build server-side rendered and statically generated
              websites that load instantly, rank higher in search engines, and
              provide seamless navigation, perfect for content-heavy sites and
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Enterprise-Grade Frontend with TypeScript Power: Create robust,
              maintainable web applications with Angular's comprehensive
              framework. Our Angular developers build enterprise-scale
              applications with TypeScript, implement two-way data binding, and
              leverage Angular's powerful CLI, delivering structured, testable,
              and highly performant frontend solutions.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Progressive Framework for Flexible Frontend Solutions: Build
              intuitive, performant interfaces with Vue.js, the progressive
              JavaScript framework loved for its simplicity and flexibility. We
              create reactive user interfaces with Vue's component system,
              implement efficient state management with Vuex, and deliver
              lightweight applications that are easy to maintain and scale.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your design requirements, user needs, and
                technical specifications to create a frontend architecture that
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our frontend developers transform designs into pixel-perfect,
                responsive interfaces while integrating with backend APIs and
                implementing interactive features seamlessly.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We conduct cross-browser testing, optimize performance, ensure
                accessibility compliance, and fine-tune every interaction to
                deliver flawless frontend experiences.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Frontend Development?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
                Proven Frontend Expertise
              </h3>
              <p className="text-[#fff] leading-relaxed">
                With 500+ completed projects and 450+ satisfied clients, we've
                mastered modern JavaScript frameworks, ensuring your interface
                is built with cutting-edge technologies.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From code splitting to lazy loading and optimization, we build
                frontends that load instantly and perform smoothly, keeping
                users engaged and conversions high.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We develop interfaces users love, every component, animation,
                and interaction is crafted to provide intuitive, delightful
