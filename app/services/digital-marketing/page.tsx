      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          ...
          <span className="text-black">
            Services | Grow Your Business with{" "}
          </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500"> Data-Driven Strategies </span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your online presence into a powerful growth engine that
          attracts and converts customers. At 2Digit Innovations, we specialize
          in data-driven digital marketing strategies including SEO, social
          media marketing, PPC advertising, and content marketing. From startups
          building brand awareness to enterprises scaling their online reach, we
          deliver marketing campaigns that drive real business results across
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Rank Higher, Get Found, Drive Organic Traffic: Dominate search
              engine results with comprehensive SEO strategies that boost your
              visibility and drive qualified organic traffic. Our experts
              optimize on-page elements, build authoritative backlinks, fix
              technical issues, and improve local presence—ensuring your
              business gets found by customers actively searching for your
              services.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Build Communities and Drive Engagement Across Platforms: Connect
              with your audience where they spend their time with strategic
              social media campaigns. We create engaging content, manage
              communities, and run targeted campaigns across Facebook,
              Instagram, LinkedIn, and Twitter—building brand awareness and
              driving conversions through authentic social engagement.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Instant Visibility with High-Converting Paid Campaigns: Drive
              immediate results with targeted PPC campaigns that maximize your
              advertising ROI. Our certified experts manage Google Ads, Facebook
              Ads, and display advertising campaigns—optimizing bids, targeting,
              and ad creative to deliver qualified leads at the lowest possible
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Valuable Content That Attracts and Converts Customers: Build trust
              and authority with strategic content that educates, engages, and
              converts your target audience. We create blog posts, articles,
              videos, and infographics that solve customer problems, improve SEO
              rankings, and guide prospects through your sales funnel
              effectively.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We analyze your current digital presence, research competitors,
                and identify opportunities to create a comprehensive marketing
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our specialists implement multi-channel campaigns with optimized
                content, targeting, and messaging designed to reach your ideal
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We continuously track performance metrics, A/B test campaigns,
                and refine strategies to maximize ROI and ensure your marketing
                dollars work harder.
              </p>
            </div>
          </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Digital Marketing?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                ...
                delivered successful campaigns across industries, ensuring your
                marketing is built with proven strategies and expertise.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From strategy to execution and optimization, we make decisions
                based on data and analytics, ensuring every marketing dollar is
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We optimize for revenue growth, every campaign, keyword, and ad
                is strategically designed to increase leads, conversions, and
