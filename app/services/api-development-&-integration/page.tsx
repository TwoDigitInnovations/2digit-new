...
export default function Home() {
  ...
  const features = [
    { title: "RESTful API Development", href: "/services/ios" },
    { title: "GraphQL Implementation", href: "/services/android" },
    {
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          API Development{"  "}
          <span className="text-black">& Integration Services | Connect  </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">Your Digital Ecosystem</span>
        </h1>
