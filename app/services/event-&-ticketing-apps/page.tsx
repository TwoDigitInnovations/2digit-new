...
export default function Home() {
  ...
  const features = [
    { title: "Event Discovery & Listings", href: "/services/ios" },
    { title: "Ticket Booking & Sales", href: "/services/android" },
    {
      title: "QR Code & Check-in Management",
      href: "/services/cross-platform",
    },
    { title: "Event Analytics & Reporting", href: "/services/android" },
  ];
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          Event & Ticketing App {"  "}
          <span className="text-black">Development Services | Sell </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">
            {" "}
            Tickets and Manage Events Seamlessly
          </span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform event management and ticket sales with powerful apps that
          streamline operations and enhance attendee experiences. At 2Digit
          Innovations, we specialize in developing comprehensive event platforms
          with ticket booking, QR code validation, event discovery, and attendee
          management. Our portfolio includes successful apps like Gurubox. From
          startups launching event marketplaces to venues managing large-scale
          events, we deliver solutions that drive real business results across
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Event & Ticketing Solutions for Your Business Growth
            </h2>
  ...
  "
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Help Attendees Find Their Perfect Events: Create engaging event
              discovery experiences with comprehensive listings, advanced search
              filters, category browsing, and personalized recommendations. We
              build platforms that showcase events beautifully with rich media,
              detailed information, and social proof, making it easy for users
              to discover and attend events they'll love.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Frictionless Ticket Purchasing That Maximizes Sales: Enable
              seamless ticket booking with instant purchase flows, multiple
              ticket types, group bookings, and secure payment processing. We
              implement seat selection, early-bird pricing, promotional codes,
              and digital ticket delivery, removing friction from the buying
              process and maximizing ticket sales.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h2>QR Code & Check-in Management</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
              Fast, Secure Entry with Digital Validation: Streamline event entry
              with QR code-based tickets and efficient check-in systems. We
              develop scanner apps for organizers, implement ticket validation,
              duplicate detection, and real-time attendance tracking ensuring
              smooth, secure entry while preventing fraud and providing instant
              attendance data.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Data-Driven Insights for Better Event Planning: Empower event
              organizers with comprehensive analytics including ticket sales
              tracking, attendee demographics, revenue reporting, and engagement
              metrics. We build intuitive dashboards that provide actionable
              insights helping organizers understand their audience, optimize
              pricing, and plan more successful events.
            </p>
      ...
      <section className="bg-[#fff] py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-14">
            Our Event & Ticketing App Development Process
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your event types, ticketing needs, and attendee
                expectations to design platforms that simplify booking and
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our designers create visually appealing event interfaces while
                developers build robust systems with booking engines, payment
                processing, QR validation, and analytics.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We conduct end-to-end testing of booking flows and check-in
                processes, optimize for peak traffic handling, then launch your
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Event & Ticketing App Development?{" "}
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
                Proven Event Tech Expertise
              </h3>
              <p className="text-[#fff] leading-relaxed">
                With successful projects like Gurubox, plus 500+ completed
                projects and 450+ satisfied clients, we understand event
                management and ticketing requirements deeply.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From event discovery to ticket purchase and check-in, we create
                frictionless experiences that delight attendees and maximize
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We build platforms that sell more tickets, every feature from
                discovery to checkout is optimized to increase conversions and
