...
export default function Home() {
  ...
  const features = [
    { title: "WordPress Development", href: "/services/ios" },
    { title: "Drupal Development", href: "/services/android" },
    {
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          CMS Development{"  "}
          <span className="text-black"> Services | Empower Your Team </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">
            to Manage Content Effortlessly
          </span>
        </h1>
        ...
        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          ...
          development that covers every layer of your web application. At 2Digit
          Innovations, we specialize in building complete web solutions using
          MERN stack, MEAN stack, and JAMstack architectures. From startups
          launching innovative platforms to enterprises building complex
          systems, we deliver seamless full-stack solutions that drive real
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete CMS Development Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              The World's Most Popular CMS, Customized for You: Build flexible,
              user-friendly websites with WordPress, powering over 40% of the
              web. Our WordPress experts create custom themes, develop powerful
              plugins, implement WooCommerce for e-commerce, and optimize for
              speed and SEO, delivering websites that are easy to manage while
              maintaining professional quality and performance.
            </p>

            <div className="space-y-4">
              {[
                "Custom theme development",
                "Plugin customization & creation",
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Enterprise-Grade CMS for Complex Content Needs: Create robust,
              scalable websites with Drupal's powerful content management
              capabilities. We build custom modules, implement complex content
              architectures, configure multi-site setups, and leverage Drupal's
              security features, delivering enterprise solutions that handle
              sophisticated content workflows and high-traffic demands.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Flexible CMS for Community and Business Sites: Develop
              feature-rich websites with Joomla's balance of power and
              usability. We create custom extensions, implement user management
              systems, build membership sites, and configure multilingual
              capabilities, delivering versatile CMS solutions perfect for
              community portals, business websites, and content-rich platforms.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your content needs, workflow requirements, and
                technical constraints to recommend and configure the optimal CMS
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our developers customize themes, create plugins or modules,
                implement custom functionality, and configure your CMS to match
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We train your team on content management, optimize for
                performance and security, then launch your CMS with
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for CMS Development?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                ...
                mastered all major CMS platforms, ensuring your content
                management system is powerful yet easy to use.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From custom themes to specialized plugins and modules, we tailor
                CMS platforms to your unique needs rather than forcing you into
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We build CMS solutions your team loves using, every interface,
                workflow, and feature is optimized to make content management
