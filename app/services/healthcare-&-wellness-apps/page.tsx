...
export default function Home() {
  ...
  const features = [
    { title: "Telemedicine & Consultations", href: "/services/ios" },
    { title: "Appointment & Scheduling", href: "/services/android" },
    {
      title: "Health Tracking & Monitoring",
      href: "/services/cross-platform",
    },
    { title: "Prescription & Medicine Management", href: "/services/pwa" },
  ];
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
         Healthcare & Wellness App{"  "}
          <span className="text-black">
           Development Services | Transform{" "}
          </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">Digital Healthcare Delivery</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
Transform healthcare delivery with innovative mobile apps that improve patient care and wellness outcomes. At 2Digit Innovations, we specialize in developing secure, compliant healthcare applications with telemedicine, appointment scheduling, and health tracking features. Our portfolio includes successful apps like Fish Guru and Fish Dawai. From startups revolutionizing healthcare access to medical institutions digitalizing services, we deliver healthcare solutions that drive real business results across the UK, USA, and India.
        </p>
...
Complete Healthcare & Wellness Solutions for Your Business Growth
            </h2>
...
Continuous Monitoring for Better Health Outcomes: Empower patients with comprehensive health tracking that monitors vitals, symptoms, and progress over time. We integrate wearable devices, implement data visualization, and enable health goal tracking, helping patients stay engaged with their health while providing providers with valuable insights.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Telemedicine & Consultations
</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
Virtual Healthcare That Connects Patients and Providers: Enable remote healthcare delivery with comprehensive telemedicine features including video consultations, chat-based support, and virtual diagnostics. We build HIPAA-compliant platforms that connect patients with healthcare providers securely—expanding access to care while reducing overhead costs and improving patient convenience.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Appointment & Scheduling

</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
Streamlined Booking That Reduces No-Shows: Simplify healthcare access with intelligent appointment scheduling and management systems. Our implementation includes calendar integration, automated reminders, waitlist management, and rescheduling options, reducing administrative burden while maximizing appointment attendance and patient satisfaction.
            </p>
...
Prescription & Medicine Management
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
Digital Prescription Management for Better Adherence: Improve medication compliance with digital prescription and medicine management features. Our systems include e-prescription generation, medication reminders, dosage tracking, and pharmacy integration, ensuring patients take medications correctly while streamlining the prescription fulfillment process.
            </p>
...
Our Healthcare & Wellness App Development Process
          </h2>
 ...
 Discovery & Compliance Planning    
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
               We understand your food business model, target market, and operational requirements to design a platform that serves restaurants, delivery partners, and customers effectively.
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
Our designers create intuitive, accessible interfaces while developers build HIPAA-compliant systems with secure data handling, telemedicine features, and health tracking capabilities.
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
We conduct thorough security testing, validate compliance with healthcare regulations, optimize patient workflows, then launch your platform on App Store and Google Play.
...
Why Choose 2Digit Innovations for Healthcare & Wellness App Development?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
               With successful projects like Fish Guru and Fish Dawai, plus 500+ completed projects and 450+ satisfied clients, we understand healthcare technology requirements deeply.
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
              From HIPAA compliance to data encryption and secure communications, we prioritize patient privacy and regulatory requirements in every healthcare solution.
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
           We build apps that improve care delivery, every feature from telemedicine to health tracking is designed to enhance patient engagement and health outcomes.
