...
export default function Home() {
  ...
  const features = [
    { title: "Product Catalog & Search", href: "/services/ios" },
    { title: "Shopping Cart & Checkout", href: "/services/android" },
    {
      title: "Payment Gateway Integration",
      href: "/services/cross-platform",
    },
    { title: "Order Tracking & Management", href: "/services/pwa" },
  ];
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
         E-commerce & Shopping App {"  "}
          <span className="text-black">
            Development Services | Turn {" "}
          </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500"> Mobile Shoppers into Loyal Customers
</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
         Transform your retail business with powerful e-commerce and shopping apps that drive sales and customer loyalty. At 2Digit Innovations, we specialize in developing feature-rich shopping applications with seamless checkout, personalized experiences, and secure payments. Our portfolio includes successful apps like Clints, Esoccer, and bachhoahoustan. From startups launching online stores to enterprises scaling mobile commerce, we deliver shopping solutions that drive real business results across the UK, USA, and India.
        </p>
...
Complete E-commerce & Shopping App Solutions for Your Business Growth
            </h2>
...
Product Catalog & Search
        ...
        Intuitive Browsing That Drives Discovery: Create engaging product catalogs with powerful search and filtering that help customers find exactly what they need. We build intuitive category navigation, advanced search with filters, product recommendations, and wish lists, making product discovery effortless and encouraging customers to explore and purchase more.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Shopping Cart & Checkout</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
            Frictionless Checkout That Maximizes Conversions: Optimize your sales funnel with streamlined shopping cart and checkout experiences. Our implementation includes persistent carts, guest checkout options, saved addresses, and one-tap purchasing, reducing cart abandonment and making it incredibly easy for customers to complete purchases.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Payment Gateway Integration

            </h2>

            <p className="text-gray-600 mb-8 max-w-xl">
            Secure, Multiple Payment Options for Every Customer: Enable seamless transactions with comprehensive payment gateway integration supporting credit cards, digital wallets, and local payment methods. We implement secure PCI-compliant payment processing with fraud detection and multiple currency support, building trust while maximizing completed transactions.
            </p>
...
Our E-commerce App Development Process
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            We analyze your products, target customers, and business model to design a shopping app that maximizes conversions and customer lifetime value.
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
               Our designers create conversion-focused interfaces while developers build robust e-commerce platforms with secure payments, inventory management, and seamless checkout flows.
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
               We conduct thorough testing of checkout flows, payment processing, and user journeys, then launch your app on App Store and Google Play with optimization
              </p>
            </div>
          </div>
        </div>
...
Proven E-commerce Expertise
              ...
              With successful projects like Clints, Esoccer, and bachhoahoustan, plus 500+ completed projects and 450+ satisfied clients, we understand mobile commerce inside out.
         ...
         Conversion-Focused Development
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
             ...
             Focus on Customer Retention
              ...
              <p className="text-[#fff] leading-relaxed">
              We build apps that customers love returning to, every personalization, notification, and loyalty feature is optimized for repeat purchases and long-term value.
