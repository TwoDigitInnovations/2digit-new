...
export default function Home() {
  ...
  const features = [
    { title: "Native iOS App Development", href: "/services/ios" },
    { title: "Native Android App Development", href: "/services/android" },
    {
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your business idea into a powerful mobile application that
          users love. At 2Digit Innovations, we specialize in creating
          high-performance mobile apps for iOS, Android, and cross-platform
          solutions. From startups launching their first app to enterprises
          scaling their digital presence, we deliver mobile experiences that
          engage users and drive real business results across the UK, USA, and
          India.
        </p>
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Mobile App Development Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Swift-Powered Apps Built for Apple Excellence: Harness the full
              power of Apple's ecosystem with native iOS applications that
              deliver exceptional performance and seamless user experiences. Our
              expert Swift developers create stunning iPhone and iPad apps that
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Reach Billions with Powerful Android Solutions: Dominate the
              world's largest mobile platform with robust Android applications
              built using Kotlin and Java. We develop high-performance apps that
              work flawlessly across thousands of Android devices, connecting
              your business with the massive Android user base.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              One Codebase. Multiple Platforms. Maximum Reach: Why choose
              between iOS and Android when you can dominate both? Our
              cross-platform development using React Native and Flutter lets you
              launch on multiple platforms simultaneously, cutting development
              time and costs in half without compromising quality.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our developers build your app using agile methodology, with
