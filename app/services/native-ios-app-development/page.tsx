...
export default function Home() {
  ...
  const features = [
    { title: "Swift Development", href: "/services/ios" },
    { title: "iPhone Apps", href: "/services/android" },
    {
      title: "iPad Apps",
      href: "/services/cross-platform",
    },
    { title: "App Store Optimization", href: "/services/pwa" },
  ];
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          ...
          <span className="text-black">
            Development Services | Build Premium{" "}
          </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">Apps for Apple Users</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your iOS app idea into a stunning reality that captivates
          Apple users worldwide. At 2Digit Innovations, we specialize in native
          iOS app development using Swift to create high-performance iPhone and
          iPad applications. From startups launching innovative apps to
          enterprises scaling their mobile presence on Apple platforms, we
          deliver iOS experiences optimized for the App Store that drive real
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Native iOS Development Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Modern, Fast, and Secure iOS Programming: Build powerful iOS
              applications with Swift, Apple's modern programming language
              designed for speed and safety. Our expert Swift developers write
              clean, efficient code that leverages the latest iOS features and
              frameworks delivering apps that perform exceptionally while being
              maintainable and scalable.
            </p>

            <div className="space-y-4">
              {[
                "Modern Swift programming",
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">iPhone Apps</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
              Stunning Applications Designed for iPhone Excellence: Create
              iPhone apps that users love with pixel-perfect designs and
              seamless functionality. We develop custom iPhone applications that
              take full advantage of device capabilities like Face ID, Apple
              Pay, and haptic feedback ensuring your app feels native and
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Maximize Visibility and Drive More Downloads: Ensure your iOS app
              gets discovered with comprehensive App Store optimization
              strategies. We optimize app titles, descriptions, keywords, and
              screenshots while managing ratings and reviews boosting your app's
              visibility in search results and increasing organic downloads
              significantly.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                "App Store SEO",
                "Screenshot & description optimization",
      ...
      <section className="bg-[#fff] py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-14">
            Our Native iOS Development Process
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your app concept, target audience, and business
                goals to create a strategic development plan that ensures App
                Store success.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our designers create iOS-compliant interfaces while Swift
                developers build robust, performant apps following Apple's Human
                Interface Guidelines and best practices.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We conduct rigorous testing across iOS devices, optimize for App
                Store guidelines, then handle submission and launch to ensure
                smooth approval and deployment.
              </p>
            </div>
          </div>
        </div>
