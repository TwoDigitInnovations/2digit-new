...
export default function Home() {
  ...
  const features = [
    { title: "Shopify Store Setup", href: "/services/ios" },
    { title: "Theme Customization", href: "/services/android" },
    {
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        Shopify Development {"  "}
         ...
         Services | Launch Your {" "}
          </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">Online Store in Days
</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
Transform your retail business with Shopify, the world's leading e-commerce platform trusted by millions of merchants. At 2Digit Innovations, we specialize in Shopify store setup, custom theme development, and app integrations that create powerful online stores. From startups launching their first store to established brands migrating to Shopify, we deliver Shopify solutions that drive real business results across the UK, USA, and India.
        </p>
...
Complete Shopify Development Solutions for Your Business Growth
            </h2>
...
Complete Store Configuration Ready to Sell: Launch your Shopify store quickly with professional setup and configuration. We handle domain connection, payment gateway setup, shipping configuration, product catalog upload, and SEO optimization—delivering fully functional stores ready to accept orders and start generating revenue from day one.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Theme Customization
</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
Unique Designs That Match Your Brand Perfectly: Transform Shopify themes into branded experiences that stand out. We customize existing themes or build custom Shopify themes from scratch, implement your brand identity, optimize for conversions, and ensure mobile responsiveness, creating beautiful stores that reflect your unique brand and drive sales.
            </p>
...
We understand your products, business goals, and design preferences to plan Shopify stores that align with your brand and maximize conversions.
...
Setup & Customization
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
Our Shopify experts configure your store, customize themes to match your brand, integrate necessary apps, and optimize for performance and SEO.
...
Testing & Launch
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
We test checkout flows, payment processing, and mobile responsiveness, train you on store management, then launch your Shopify store ready for customers.
...
Why Choose 2Digit Innovations for Shopify Development?
          </h2>
...
With 500+ completed projects and 450+ satisfied clients, we're experienced Shopify partners who understand the platform's capabilities and best practices deeply.
...
Fast Time-to-Market 
              ...
              <p className="text-[#fff] leading-relaxed">
From setup to customization and launch, we leverage Shopify's powerful platform to get your store online quickly without sacrificing quality or functionality.
              </p>
            </div>
...
Focus on Sales Growth 
              ...
              <p className="text-[#fff] leading-relaxed">
 We build Shopify stores that convert, every theme customization, app integration, and optimization is designed to maximize your online revenue and customer satisfaction.
