...
export default function Home() {
  ...
  const features = [
    { title: "Driver & Passenger Apps", href: "/services/ios" },
    { title: "Real-Time GPS Tracking", href: "/services/android" },
    {
      title: "Intelligent Ride Matching",
      href: "/services/cross-platform",
    },
    { title: "Payment Integration", href: "/services/pwa" },
  ];
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
         Ride-Sharing & Transportation {"  "}
          ...
          <span className="text-yellow-500"> Build the Next Mobility Solution
</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
        Transform urban transportation with powerful ride-sharing and mobility apps that connect drivers and passengers seamlessly. At 2Digit Innovations, we specialize in developing comprehensive transportation platforms with real-time tracking, intelligent matching, and secure payments. Our portfolio includes successful apps like Carloop and SK APP. From startups disrupting mobility to enterprises launching fleet services, we deliver ride-sharing solutions that drive real business results across the UK, USA, and India.
        </p>
...
Complete Ride-Sharing & Transportation Solutions for Your Business Growth
            </h2>
...
Driver & Passenger Apps
            ...
            Seamless Dual-App Experience for All Users: Build comprehensive ride-sharing platforms with dedicated apps for both drivers and passengers. We develop intuitive interfaces that make booking rides effortless for passengers while providing drivers with efficient tools for accepting rides, navigation, and earnings management creating smooth experiences for your entire ecosystem.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Real-Time GPS Tracking
</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
           Live Location Tracking for Safety and Transparency: Ensure passenger safety and transparency with accurate real-time GPS tracking throughout every ride. Our implementation provides live location updates, estimated arrival times, and route visualization giving passengers peace of mind while helping drivers navigate efficiently to destinations.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Intelligent Ride Matching</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
         Smart Algorithms That Connect Riders Instantly: Optimize ride efficiency with intelligent matching algorithms that connect passengers with nearby drivers in seconds. Our ride-matching system considers distance, driver ratings, vehicle type, and traffic conditions ensuring fast pickups, optimal routes, and maximum satisfaction for both drivers and passengers.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
          Secure, Seamless Payment Processing: Enable hassle-free transactions with comprehensive payment integration supporting multiple methods. We implement secure payment gateways, digital wallets, cash handling, and automated fare calculation with surge pricing ensuring smooth transactions while maximizing revenue and trust in your platform.
            </p>
...
Our Ride-Sharing App Development Process
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
             ...
             Discovery & Strategy 
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
               We analyze your target market, competition, and business model to design a ride-sharing platform that addresses specific mobility needs and stands out.
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our team creates intuitive interfaces for drivers and passengers while building robust backend systems with GPS tracking, matching algorithms, and payment processing.
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
             ...
             Testing & Launch
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
              We conduct real-world testing with drivers and riders, optimize performance and matching accuracy, then launch your platform on App Store and Google Play.
...
Why Choose 2Digit Innovations for Ride-Sharing App Development?
          </h2>
...
Proven Transportation Expertise
              </h3>
              <p className="text-[#fff] leading-relaxed">
 With successful projects like Carloop and SK APP, plus 500+ completed projects and 450+ satisfied clients, we understand the unique challenges of mobility platforms.
           ...
           Complete Platform Development 
              ...
              <p className="text-[#fff] leading-relaxed">
              From passenger and driver apps to admin dashboards and backend infrastructure, we deliver end-to-end ride-sharing solutions that scale with your growth.
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
          Focus on Market Success
              </h3>
              <p className="text-[#fff] leading-relaxed">
                We build platforms that attract users and drivers, every feature from matching algorithms to payment systems is optimized for engagement, retention, and profitability.
