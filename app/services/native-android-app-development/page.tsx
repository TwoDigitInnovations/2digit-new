...
export default function Home() {
  ...
  const features = [
    { title: "Kotlin/Java Development", href: "/services/ios" },
    { title: "Google Play Optimization", href: "/services/android" },
    {
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          ...
          <span className="text-black">
            Development Services | Reach Billions on{" "}
          </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500"> the World's Largest Platform</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your Android app vision into a powerful reality that
          dominates the world's most popular mobile platform. At 2Digit
          Innovations, we specialize in native Android app development using
          Kotlin and Java to create high-performance applications for
          smartphones and tablets. From startups launching innovative apps to
          enterprises scaling their mobile presence on Google Play, we deliver
          Android experiences optimized for maximum reach that drive real
          business results across the UK, USA, and India.
        </p>
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Native Android Development Solutions for Your Business
              Growth
            </h2>
  ...
  "
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Maximize Visibility and Skyrocket Your Downloads: Ensure your
              Android app reaches millions with comprehensive Google Play
              optimization strategies. We optimize app titles, descriptions,
              keywords, screenshots, and manage user reviews boosting your app's
              ranking in search results, increasing organic downloads, and
              maximizing your app's success on the platform.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Optimized Experiences for Large-Screen Devices: Design and develop
              Android tablet applications that leverage larger screens and
              unique capabilities. Our tablet apps feature responsive layouts,
              multi-window support, and stylus integration perfect for
              productivity tools, educational apps, and immersive experiences
              that take full advantage of tablet form factors.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">iPad Apps</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
              Powerful Tablet Experiences for Productivity: Design and develop
              iPad applications that leverage the tablet's larger screen and
              unique capabilities. Our iPad apps feature adaptive layouts,
              multitasking support, and Apple Pencil integration perfect for
              productivity tools, creative applications, and immersive
              experiences that maximize iPad's potential.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Modern, Robust Android Programming Excellence: Build exceptional
              Android applications with Kotlin and Java, the industry-standard
              languages for Android development. Our expert developers write
              efficient, scalable code that leverages Android's powerful
              features and frameworks delivering apps that perform flawlessly
              across thousands of device configurations while being maintainable
              and future-proof.
            </p>
      ...
      <section className="bg-[#fff] py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-14">
            Our Native Android Development Process
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your app requirements, target audience, and
                business objectives to create a strategic development roadmap
                that ensures Google Play success.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our designers create Material Design-compliant interfaces while
                Kotlin/Java developers build robust, high-performance apps
                following Android best practices and guidelines.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-[#4a4a4a] mb-4">
                Testing & Google Play Launch
              </h3>
              <p className="text-[#6b6b6b] leading-relaxed">
                We conduct comprehensive testing across multiple devices and
                Android versions, optimize for Play Store guidelines, then
                manage submission and launch for smooth approval.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Native Android Development?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                ...
                launched successful Android apps across categories, ensuring
                your app reaches its full potential on the platform.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From Kotlin best practices to Material Design guidelines and
                Google Play requirements, we follow Android standards to ensure
                quality, consistency, and user satisfaction.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We build apps that maximize your audience, every feature and
                optimization is designed to reach Android's billions of users
                and drive downloads globally.
              </p>
            </div>
          </div>
        </div>
