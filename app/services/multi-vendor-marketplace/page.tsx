...
export default function Home() {
  ...
  const features = [
    { title: "Headless Commerce", href: "/services/ios" },
    { title: "Custom Shopping Experiences", href: "/services/android" },
    // {
    //   title: "C2C Marketplaces",
    //   href: "/services/cross-platform",
    // },
    // { title: "Progressive Web Apps (PWA)", href: "/services/pwa" },
    // {
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
         Multi-Vendor Marketplace {"  "}
          ...
          <span className="text-yellow-500">Thriving Online Marketplaces</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
Transform your e-commerce vision into reality with custom solutions that break free from platform limitations. At 2Digit Innovations, we specialize in developing bespoke e-commerce systems including headless commerce architectures and fully customized shopping experiences tailored to your unique business needs. From innovative startups to enterprises with complex requirements, we deliver custom e-commerce solutions that drive real business results across the UK, USA, and India.
        </p>
...
Complete Custom E-commerce Solutions for Your Business Growth
            </h2>
...
Flexible Architecture for Omnichannel Excellence: Build modern headless commerce systems that separate frontend presentation from backend commerce logic. We develop API-first architectures, implement decoupled frontends, enable omnichannel selling, and integrate with any frontend technology, giving you unlimited flexibility to deliver unique shopping experiences across web, mobile, IoT, and emerging channels.
            </p>
...
Custom Shopping Experiences
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
Tailored E-commerce Built Exactly for Your Needs: Create fully customized shopping platforms designed specifically for your business model and customer journey. We build unique checkout flows, implement specialized product configurators, develop custom pricing engines, and create branded experiences, delivering e-commerce solutions that match your vision perfectly without platform constraints.
...
C2C Marketplaces
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
Enable Peer-to-Peer Commerce Like eBay and Etsy: Create C2C marketplaces that connect individual sellers with buyers. We implement user verification systems, build auction and bidding features, add secure escrow payments, and create dispute resolution, facilitating safe peer-to-peer transactions for pre-owned goods, handmade items, or services.
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              The Future of Mobile, No Download Required: Bridge the gap between
              web and mobile with Progressive Web Apps that deliver app-like
              experiences directly through browsers. No app store approvals, no
              download barriers—just instant access with powerful functionality.
            </p>
...
Our Custom E-commerce Development Process
          </h2>
...
We understand your unique business requirements, customer needs, and technical constraints to design custom e-commerce architectures that deliver competitive advantages.
...
Custom Development & Integration 
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
Our developers build bespoke e-commerce systems from scratch, implement custom business logic, integrate specialized services, and create exactly what you envision.
...
Testing & Deployment
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
We conduct comprehensive testing of custom features, optimize performance and scalability, ensure security compliance, then deploy your unique 
              </p>
            </div>
          </div>
        </div>
...
Why Choose 2Digit Innovations for Custom E-commerce Solutions?
          </h2>
...
Proven Custom Development Expertise
              </h3>
              <p className="text-[#fff] leading-relaxed">
With 500+ completed projects and 450+ satisfied clients, we've built custom e-commerce systems across industries, ensuring your unique vision becomes reality.
...
No Platform Limitations 
              ...
              <p className="text-[#fff] leading-relaxed">
From headless architecture to completely custom builds, we create e-commerce solutions that match your exact requirements without compromising on features or functionality.
...
Focus on Competitive Advantage
              ...
              <p className="text-[#fff] leading-relaxed">
We build solutions that differentiate you, every custom feature, workflow, and experience is designed to give you advantages competitors using standard platforms can't match.
