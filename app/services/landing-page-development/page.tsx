...
export default function Home() {
  ...
  const features = [
    { title: "Conversion-Focused Design", href: "/services/ios" },
    { title: "A/B Testing Ready", href: "/services/android" },
    {
      title: "Fast Loading Performance",
      href: "/services/cross-platform",
    },
    { title: "Lead Capture Optimization", href: "/services/pwa" },
  ];
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          ...
          <span className="text-black"> Services | Convert </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">Visitors into Customers</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your marketing campaigns with high-converting landing pages
          that turn traffic into leads and sales. At 2Digit Innovations, we
          specialize in developing conversion-optimized landing pages with
          compelling designs, persuasive copy layouts, and seamless user
          journeys. Our portfolio includes successful projects like SK app
          landing page, Opinion Trade, and Paulbabar. From startups launching
          products to enterprises running campaigns, we deliver landing pages
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Landing Page Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Designs That Guide Visitors to Take Action: Create landing pages
              with laser-focused designs that eliminate distractions and drive
              conversions. We craft attention-grabbing headlines, design
              compelling call-to-action buttons, implement persuasive visual
              hierarchies, and create seamless user flows, ensuring every
              element works together to maximize your conversion rates.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Optimize Performance with Data-Driven Testing: Build landing pages
              ready for continuous optimization through A/B testing. We
              implement testing frameworks, create multiple variations,
              integrate analytics tracking, and design modular components,
              enabling you to test headlines, CTAs, images, and layouts to
              discover what converts best for your audience.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Speed That Keeps Visitors Engaged: Ensure instant page loads with
              performance-optimized landing pages that keep visitors from
              bouncing. We implement image optimization, minify code, leverage
              browser caching, and use CDN delivery, delivering pages that load
              in under 2 seconds to maximize engagement and conversions.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your campaign goals, target audience, and
                conversion objectives to design landing pages that align
                perfectly with your marketing strategy.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our designers create conversion-focused layouts while developers
                build fast-loading, responsive pages with optimized forms, CTAs,
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We conduct usability testing, optimize for speed and
                conversions, set up analytics tracking, then launch your landing
                page ready for immediate traffic and results.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Landing Page Development?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
                Proven Conversion Expertise
              </h3>
              <p className="text-[#fff] leading-relaxed">
                With successful projects like SK app landing page, Opinion
                Trade, and Paulbabar, plus 500+ completed projects and 450+
                satisfied clients, we know what converts.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
                Marketing-Focused Development
              </h3>
              <p className="text-[#fff] leading-relaxed">
                From psychology-driven design to performance optimization, every
                element is crafted specifically to maximize your marketing ROI
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We build landing pages that deliver measurable outcomes, every
                design choice, CTA, and optimization is focused on turning
