...
export default function Home() {
  ...
  const features = [
    { title: "iOS Shopping Apps", href: "/services/ios" },
    { title: "Android Shopping Apps", href: "/services/android" },
    // {
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      E-commerce App Development {"  "}
          <span className="text-black">
            Services | Turn Mobile {" "}
          </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500"> Shoppers into Loyal Customers
</span>
        </h1>
...
Complete E-commerce App Solutions for Your Business Growth
            </h2>
...
Premium Shopping Experiences for Apple Users: Build native iOS shopping apps that leverage Apple's ecosystem for seamless commerce. We develop Swift-based applications with Apple Pay integration, Face ID authentication, push notifications for deals, and App Store optimization, creating premium shopping experiences that convert iPhone and iPad users into loyal customers.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Android Shopping Apps
</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
Reach Billions on the World's Largest Platform: Create high-performance Android shopping apps that dominate Google Play. We build Kotlin-based applications with Google Pay integration, fingerprint authentication, personalized recommendations, and material design, delivering shopping experiences that engage Android's massive user base and drive consistent sales growth.
            </p>
...
Order Tracking & Management
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
         Real-Time Updates That Build Customer Confidence: Keep customers informed with comprehensive order tracking and management features. We implement real-time order status updates, push notifications for shipment milestones, delivery tracking, and order history, reducing support queries while increasing customer satisfaction and repeat purchases.
            </p>
...
We understand your products, mobile customers, and business goals to design shopping apps that maximize mobile conversions and customer lifetime value.
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
Our designers create intuitive mobile shopping interfaces while developers build native apps with secure payments, product catalogs, and personalized features.
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
We conduct thorough testing of shopping flows, payment processing, and performance, optimize for App Store and Google Play, then launch your apps ready for downloads.
              </p>
            </div>
          </div>
        </div>
...
Why Choose 2Digit Innovations for E-commerce App Development?
          </h2>
...
Proven Mobile Commerce Expertise
              </h3>
              <p className="text-[#fff] leading-relaxed">
With 500+ completed projects and 450+ satisfied clients, we've built successful shopping apps that drive mobile sales and customer engagement.
...
Native Performance Excellence
              ...
              <p className="text-[#fff] leading-relaxed">
From smooth scrolling to instant loading, we build native apps that deliver superior performance and user experiences compared to web or hybrid alternatives.
...
Focus on Mobile Revenue 
              ...
              <p className="text-[#fff] leading-relaxed">
We build apps that maximize mobile sales, every feature from push notifications to one-tap checkout is optimized to increase conversions and repeat purchases.
