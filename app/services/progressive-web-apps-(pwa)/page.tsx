...
export default function Home() {
  ...
  const features = [
    { title: "PWA Development", href: "/services/ios" },
    { title: "Offline Functionality", href: "/services/android" },
    {
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          ...
          <span className="text-black">(PWA) Development Services | App </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">Experiences Without Downloads</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform your web presence into powerful app-like experiences that
          work instantly across all devices without app store barriers. At
          2Digit Innovations, we specialize in Progressive Web App development
          that combines the reach of the web with the functionality of native
          apps. From startups reducing friction to enterprises maximizing
          accessibility, we deliver PWA solutions with offline capabilities and
          engagement features that drive real business results across the UK,
          USA, and India.
        </p>
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Progressive Web App Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Modern Web Apps That Feel Native: Build cutting-edge Progressive
              Web Apps that deliver seamless, app-like experiences directly
              through browsers. Our PWA experts leverage modern web technologies
              including service workers, web app manifests, and responsive
              design creating fast, reliable applications that work on any
              device without requiring app store downloads or installations.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Uninterrupted Access Without Internet Connection: Ensure your PWA
              works flawlessly even without internet connectivity with robust
              offline functionality. We implement intelligent caching strategies
              and background sync that allow users to access content, complete
              tasks, and interact with your app offline, syncing data
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Engage Users with Timely, Relevant Notifications: Keep users
              engaged and coming back with powerful push notification
              capabilities. Our PWA push notification implementation enables
              real-time updates, personalized messages, and re-engagement
              campaigns, all without requiring app installation, helping you
              boost user retention and drive conversions effectively.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your user needs, content strategy, and engagement
                goals to create a PWA roadmap that maximizes accessibility and
                user retention.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our designers create responsive, app-like interfaces while
                developers build PWAs with service workers, offline
                capabilities, and push notifications using modern web standards.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We test across browsers and devices, optimize performance and
                caching strategies, then deploy your PWA with SEO optimization
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Progressive Web App Development?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
                Proven PWA Expertise
              </h3>
              <p className="text-[#fff] leading-relaxed">
                With 500+ completed projects and 450+ satisfied clients, we've
                built successful Progressive Web Apps across industries,
                ensuring your PWA delivers exceptional experiences.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From instant access to zero installation friction, we create
                PWAs that users can start using immediately with just a URL,
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We build PWAs that retain users, every offline feature,
                notification, and performance optimization is designed to
                maximize engagement, return visits, and business value.
              </p>
            </div>
          </div>
        </div>
