...
export default function Home() {
  ...
  const features = [
    { title: "Custom Store Design", href: "/services/ios" },
    { title: "Product Catalog Management", href: "/services/android" },
    {
      title: "Secure Payment Processing",
      href: "/services/cross-platform",
    },
    { title: "Order & Inventory Management", href: "/services/pwa" },
  ];
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        E-commerce Website {"  "}
          ...
          <span className="text-yellow-500">Online Stores That Sell
</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
Transform your retail business with powerful e-commerce websites that drive sales and deliver exceptional shopping experiences. At 2Digit Innovations, we specialize in developing feature-rich online stores with seamless checkout, secure payments, and conversion-optimized designs. Our portfolio includes successful projects like XO Candles, Octopusgifts, and Primax Trading. From startups launching online stores to established retailers expanding digital presence, we deliver e-commerce solutions that drive real business results across the UK, USA, and India.
        </p>
...
Complete E-commerce Website Solutions for Your Business Growth
            </h2>
...
Beautiful Storefronts That Convert Browsers into Buyers: Create visually stunning e-commerce websites with conversion-focused designs that showcase products beautifully. We craft compelling homepage layouts, design intuitive category pages, create detailed product pages with high-quality imagery, and implement persuasive checkout flows—ensuring every design element drives sales and builds customer confidence.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Product Catalog Management</h2>

            <p className="text-gray-600 mb-8 max-w-xl">
Organize and Showcase Unlimited Products Effortlessly: Build scalable product catalogs with powerful management systems that handle thousands of items. We implement advanced search and filtering, create product variations (size, color), enable bulk product uploads, and design intuitive category structures, making it easy for customers to find products and for you to manage inventory.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Secure Payment Processing

            </h2>

            <p className="text-gray-600 mb-8 max-w-xl">
Multiple Payment Options with Bank-Grade Security: Enable seamless transactions with secure payment gateway integration supporting credit cards, digital wallets, and local payment methods. We implement PCI-compliant payment processing, add fraud detection, support multiple currencies, and ensure encrypted transactions, building trust while maximizing completed purchases.
            </p>
...
Order & Inventory Management
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
Streamline Operations with Automated Systems: Manage orders and inventory efficiently with comprehensive backend systems. We build order tracking dashboards, implement automated stock updates, create shipping integration, and generate sales reports, reducing manual work while ensuring accurate inventory levels and timely orde
            </p>
...
We understand your products, target customers, and business goals to design e-commerce websites that maximize conversions and average order value.
...
Design & Development
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
Our designers create conversion-focused shopping experiences while developers build secure, scalable stores with payment processing, inventory management, and shipping integration.
 ...
 Testing & Launch
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
We conduct thorough testing of checkout flows, payment processing, and inventory systems, optimize for performance and SEO, then launch your store ready for sales.
              </p>
            </div>
          </div>
        </div>
...
Why Choose 2Digit Innovations for E-commerce Website Development?
          </h2>
...
With successful projects like XO Candles, Octopusgifts, and Primax Trading, plus 500+ completed projects and 450+ satisfied clients, we understand online retail deeply.
         ...
         Conversion-Focused Development
              ...
              <p className="text-[#fff] leading-relaxed">
            From product discovery to checkout completion, every feature is designed to reduce friction, increase average order value, and maximize your mobile revenue.
...
Conversion-Focused Development 
              ...
              <p className="text-[#fff] leading-relaxed">
From product pages to checkout completion, every feature is designed to reduce friction, increase average order value, and maximize your online revenue.
...
We build stores that generate revenue, every design choice, feature, and optimization is focused on turning visitors into customers and customers into repeat buyers.
          </p>
        </div>
