...
export default function Home() {
  ...
  const features = [
    { title: "Restaurant & Menu Management", href: "/services/ios" },
    { title: "Real-Time Order Processing", href: "/services/android" },
    {
      title: "Delivery Tracking & Management",
      href: "/services/cross-platform",
    },
    { title: "Meal Planning & Recommendations", href: "/services/pwa" },
  ];
    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="text-center mt-4 md:mt-20 px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl text-yellow-500 font-bold leading-tight relative z-20">
          ...
          <span className="text-black">Development Services | Deliver </span>
          <br className="hidden md:block" />
          <span className="text-yellow-500">Delicious Experiences</span>
        </h1>

        <p className="text-gray-600 mt-6 text-base md:text-lg max-w-3xl mx-auto relative z-20">
          Transform the food industry with innovative food delivery and meal
          planning apps that connect customers with their favorite meals. At
          2Digit Innovations, we specialize in developing comprehensive food
          platforms with real-time ordering, delivery tracking, and personalized
          meal recommendations. Our portfolio includes successful apps like
          MealWise. From startups disrupting food delivery to enterprises
          launching restaurant solutions, we deliver food app experiences that
          drive real business results across the UK, USA, and India.
        </p>
        ...
        <section className="py-8 md:py-16">
          <div className="relative z-10 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-6 md:mb-12">
              Complete Food & Meal Planning Solutions for Your Business Growth
            </h2>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Comprehensive Restaurant Solutions in One Platform: Build powerful
              food apps with complete restaurant and menu management
              capabilities. We develop systems for multiple restaurant listings,
              dynamic menu updates, item customization options, and restaurant
              ratings, giving customers choice while providing restaurants with
              tools to showcase their offerings effectively.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Seamless Ordering from Browse to Checkout: Create frictionless
              ordering experiences with instant order processing and
              confirmation. Our implementation includes real-time order
              placement, automated kitchen notifications, order status updates,
              and estimated delivery times, ensuring customers stay informed
              while restaurants receive orders instantly.
            </p>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#F4F0FF] to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Live Tracking for Peace of Mind: Keep customers engaged with
              real-time delivery tracking from restaurant to doorstep. We
              implement GPS-based tracking, driver location updates, route
              optimization, and delivery notifications, providing transparency
              and building trust while optimizing delivery efficiency for your
              platform.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              Personalized Food Discovery That Drives Orders: Enhance user
              experience with intelligent meal planning and personalized
              recommendations. Our systems analyze user preferences, dietary
              restrictions, order history, and ratings to suggest relevant
              meals, helping customers discover new favorites while increasing
      ...
      <section className="bg-[#fff] py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-14">
            Our Food & Meal Planning App Development Process
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We understand your food business model, target market, and
                operational requirements to design a platform that serves
                restaurants, delivery partners, and customers effectively.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                Our designers create appetizing interfaces while developers
                build robust systems with order management, real-time tracking,
                payment processing, and restaurant integration.
              </p>
            </div>
            ...
            <div className="bg-[#f7f7f2] border-[6px] border-[#6B5AFF] rounded-[32px] p-8 shadow-sm">
              ...
              <p className="text-[#6b6b6b] leading-relaxed">
                We conduct real-world testing with restaurants and delivery
                partners, optimize order flows and tracking accuracy, then
                launch your platform on App Store and Google Play.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#fff]  px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0b1437] mb-16">
            Why Choose 2Digit Innovations for Native iOS Development?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <h3 className="text-xl font-semibold text-[#fff] mb-3">
                Proven iOS Expertise
              </h3>
              <p className="text-[#fff] leading-relaxed">
                With 500+ completed projects and 450+ satisfied clients, we've
                launched successful iOS apps across categories, ensuring your
                app is built with deep Apple platform expertise.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-[#6B5AFF] rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                From Swift coding standards to Human Interface Guidelines and
                App Store requirements, we follow Apple's best practices to
                ensure quality and approval.
              </p>
            </div>
            ...
            <div className="bg-[#6B5AFF] border-[6px] border-white rounded-[36px] p-10">
              ...
              <p className="text-[#fff] leading-relaxed">
                We build apps that iOS users love, every interaction, animation,
                and feature is crafted to deliver the premium experience Apple
                users expect.
              </p>
            </div>
          </div>
