...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes, the SaaS solution can be customized to match your branding and requirements.",
  },
  {
    question: "What Features Does Your SaaS Food Delivery App Offer?",
    answer:
      "The app includes order management, payment integration, real-time tracking, and more.",
  },
  {
    question:
      "How Long Does Launching a Food Delivery App Using Your SaaS Solution Take?",
    answer:
      "It usually takes a few days to set up and launch the app, depending on customization.",
  },
  {
    question:
      "Do You Provide Technical Support and Maintenance for Your SaaS App?",
    answer:
      "Yes, we provide ongoing support and maintenance for all our clients.",
  },
  {
    question:
      "Can we Integrate Our Existing Payment Gateway and POS Systems?",
    answer:
      "Yes, our platform supports integration with existing payment gateways and POS systems.",
  },
  {
    question: "Is the App Compatible with both iOS and Android Platforms?",
    answer:
      "Yes, the app is fully compatible with both iOS and Android devices.",
  },
  {
    question: "How Secure is the Customer and Payment Data on Your Platform?",
    answer:
      "We use industry-standard encryption and security protocols to protect all data.",
  },
];
